...
class Cart extends React.Component {
    ...
    changeProductNumber(cid, event) {
        ...
        // 向服务器端发送请求 告诉服务器端要将哪个商品的数量更改成什么
                        ...
                        <div className="cart-row" key={product.id}>
                            ...
                            <div className="cart-quantity cart-column">
                                <input
                                    ...
                                    type="number"
                                    value={product.count} onChange={e => this.changeProductNumber(product.id, e)}
                                />
                                <button
            ...
            <div className="cart-total">
                ...
                <span className="cart-total-price">￥{
                    carts.reduce((total, product) => {
                        return total += Number(product.count) * Number(product.price)
                    },0)
                }</span>
            </div>
        </section>
